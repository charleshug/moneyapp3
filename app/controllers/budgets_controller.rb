class BudgetsController < ApplicationController
  ...
  def index
    ...
    # Show up to 4 months: two before, selected, one after (responsive: 1 col on small, 2 md, 3 lg, 4 xl)
    @display_months = [
    ...
    # Per-month summary for the summary block above each month column
