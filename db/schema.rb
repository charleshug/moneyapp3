...
ActiveRecord::Schema[7.2].define(version: 2025_05_14_182127) do
  ...
  create_table "categories", force: :cascade do |t|
    ...
    t.index ["budget_id", "order"], name: "index_categories_on_budget_id_and_order", unique: true
  ...
  create_table "subcategories", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.integer "order", null: false
    t.index ["category_id", "order"], name: "index_subcategories_on_category_id_and_order", unique: true
  ...
  create_table "trxes", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.boolean "transfer_child", default: false, null: false
    t.index ["account_id"], name: "index_trxes_on_account_id"
    t.index ["transfer_child"], name: "index_trxes_on_transfer_child"
